...
_bst_display:
    ...
    # go left
    lea 8(%rdi), %rdi
    lea __bst_display_print_number(%rip), %r10
    sub $8, %r15
    mov %r10, (%r15)
    jmp _bst_display

__bst_display_print_number:    
    # print number
    mov (%r15), %rdi
    ...
    lea __bst_display_almost_done(%rip), %r10
    sub $8, %r15
    mov %r10, (%r15)
    jmp _bst_display
__bst_display_almost_done:
    add $8, %r15
...
__loop_end:
    ...
    lea __bst_display_really_done(%rip), %r10
    sub $8, %r15
    mov %r10, (%r15)
    jmp _bst_display
__bst_display_really_done:
    lea output(%rip), %rbx
_done:
    ret
